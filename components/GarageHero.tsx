...
export default function GarageHero({ garage }: { garage?: Garage | null }) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      >
        {/* DVSA Approved Badge - Commented out per requirements */}
        ...
        {/* Rotating Subheadline - separate from h1, with breathing room */}
        {rotatingMessages.length > 0 && (
          <AnimatePresence mode="wait">
            <motion.h2
              ...
              className="text-2xl sm:text-3xl text-white/90 font-medium mb-4 text-center"
            >
        ...
        {/* Tagline paragraph - improved styling and spacing */}
        {subtext && (
          <p className="text-base sm:text-lg text-white/70 max-w-xl mb-6 text-center mx-auto">
            {subtext}
          </p>
        )}
        ...
        <motion.div
          variants={itemVariants}
          className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-base text-gray-400 mt-8"
        >
