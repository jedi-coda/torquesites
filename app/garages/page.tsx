...
export default function HomePage() {
  ...
  return (
    <>
      {/* Switcher Bar */}
      <div className="w-full bg-gray-900 text-white text-sm flex justify-center gap-6 py-2 sticky top-0 z-50">
        <a href="/genie" className="hover:underline">
          🚗 For Drivers
        </a>
        <a href="/garages" className="hover:underline">
          🛠 For Garages
        </a>
      </div>
